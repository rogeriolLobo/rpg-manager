import { Archive, BookOpen, CalendarDays, Castle, Gauge, GitFork, Globe2, LogOut, Menu, NotebookPen, PawPrint, Settings, Shield, UsersRound, UserRound, X } from 'lucide-react';
